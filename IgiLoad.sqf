...
if (IL_DevMod) then
{
	Player globalChat Format["", IL_Script_Inst];
};
...
if (isnil "IL_Variables") then
{
	...
	IL_Para_Smoke_Default = "SmokeshellRed";
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_mas_mar_Offroad_01_F" ,"max_jeep_black", "max_jeep_blue", "max_jeep_green", "max_jeep_red", "max_suv_black", "max_suv_blue", "max_suv_green", "max_suv_red", "max_H3_urbancamo", "max_H3_vegeta", "max_H3_yellow", "max_jeep_black", "max_jeep_blue", "max_jeep_green", "max_jeep_red", "max_van_blue", "max_van_green", "shounka_monsteur", "shounka_monsteur_bleufonce", "shounka_monsteur_grise", "shounka_monsteur_jaune", "shounka_monsteur_noir", "shounka_monsteur_orange", "shounka_monsteur_rose", "shounka_monsteur_rouge", "shounka_monsteur_violet", "Mr_Own_hummer_civ_bleufonce", "Mr_Own_hummer_civ_grise", "Mr_Own_hummer_civ_jaune", "Mr_Own_hummer_civ_noir", "Mr_Own_hummer_civ_orange", "Mr_Own_hummer_civ_rose", "Mr_Own_hummer_civ_rouge"];
	IL_Supported_Vehicles_VAN = ["C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Van_01_transport_F", "max_van_blue","max_van_green", "max_van_Grey", "max_van_red", "max_van_white", "max_van_cola","max_van_green" ,"max_H3_urbancamo", "max_H3_vegeta", "max_H3_yellow" ,"Mrshounka_Vandura_civ" ,"Mrshounka_Vandura_civ_bleufonce" ,"Mrshounka_Vandura_civ_jaune", "Mrshounka_Vandura_civ_noir", "Mrshounka_Vandura_civ_rose", "Mrshounka_Vandura_civ_rouge", "Mrshounka_Vandura_civ_violet"];
	IL_Supported_Vehicles_HEMTT = ["B_Truck_01_covered_F", "B_Truck_01_transport_F", "B_Truck_01_box_F", "Marinir_Truck_01_box_FG", "Marinir_Truck_01_transport_FG", "Marinir_Truck_01_covered_FG", "B_mas_mar_Truck_01_covered_F", "B_mas_mar_Truck_01_transport_F" ,"Mrshounka_a3_iveco_f" ,"shounka_ivceco_bleufonce" ,"shounka_ivceco_grise" ,"shounka_ivceco_noir" ,"shounka_ivceco_orange" ,"shounka_ivceco_rose" ,"shounka_ivceco_rouge" ,"shounka_ivceco_violet"];
	...
	IL_Supported_Vehicles_TEMPEST = ["O_Truck_03_transport_F", "O_Truck_03_covered_F" ,"shounka_a3_dafxf_euro6_f"];
	...
	//Supported cargo
	IL_Supported_HEMTT = ["B_Truck_01_covered_F", "B_Truck_01_transport_F", "B_Truck_01_box_F", "Marinir_Truck_01_box_FG", "Marinir_Truck_01_transport_FG", "Marinir_Truck_01_covered_FG", "B_mas_mar_Truck_01_covered_F", "B_mas_mar_Truck_01_transport_F", "B_Truck_01_mover_F", "B_Truck_01_ammo_F", "B_Truck_01_fuel_F", "B_Truck_01_medical_F", "B_Truck_01_Repair_F" ,"Mrshounka_a3_iveco_f" ,"shounka_ivceco_bleufonce" ,"shounka_ivceco_grise" ,"shounka_ivceco_noir" ,"shounka_ivceco_orange" ,"shounka_ivceco_rose" ,"shounka_ivceco_rouge" ,"shounka_ivceco_violet"];
	...
	IL_Supported_TEMPEST = ["O_Truck_03_transport_F", "O_Truck_03_covered_F" ,"shounka_a3_dafxf_euro6_f"];
	...
	IL_Supported_VAN = ["C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Van_01_transport_F", "max_van_blue","max_van_green", "max_van_Grey", "max_van_red", "max_van_white", "max_van_cola","max_van_green" ,"max_H3_urbancamo", "max_H3_vegeta","max_H3_yellow" ,"Mrshounka_Vandura_civ" ,"Mrshounka_Vandura_civ_bleufonce" ,"Mrshounka_Vandura_civ_jaune", "Mrshounka_Vandura_civ_noir", "Mrshounka_Vandura_civ_rose", "Mrshounka_Vandura_civ_rouge", "Mrshounka_Vandura_civ_violet"];
	IL_Supported_OFFROAD = ["C_Offroad_01_F", "B_G_Offroad_01_F", "B_G_Offroad_01_armed_F", "JTF2_Offroad_armed_01", "B_mas_mar_Offroad_01_F", "B_mas_mar_Offroad_01_armed_F" ,"max_jeep_black", "max_jeep_blue", "max_jeep_green", "max_jeep_red", "max_suv_black","max_suv_blue", "max_suv_green", "max_suv_red", "max_H3_urbancamo", "max_H3_vegeta", "max_H3_yellow","max_jeep_black", "max_jeep_blue", "max_jeep_green", "max_jeep_red", "max_van_blue", "max_van_green", "shounka_monsteur", "shounka_monsteur_bleufonce", "shounka_monsteur_grise", "shounka_monsteur_jaune", "shounka_monsteur_noir", "shounka_monsteur_orange", "shounka_monsteur_rose", "shounka_monsteur_rouge", "shounka_monsteur_violet", "Mr_Own_hummer_civ_bleufonce", "Mr_Own_hummer_civ_grise", "Mr_Own_hummer_civ_jaune", "Mr_Own_hummer_civ_noir", "Mr_Own_hummer_civ_orange", "Mr_Own_hummer_civ_rose", "Mr_Own_hummer_civ_rouge"];
	IL_Supported_SUV = ["C_SUV_01_F", "max_impala_black", "max_impala_blue", "max_impala_red", "max_impala_white" ,"SIG_SuperBeeL", "SIG_SuperBeeB", "SIG_SuperBeeG", "SIG_SuperBeeM", "SIG_SuperBee", "SIG_SuperBeeY", "SIG_Magnums", "SIG_Hubcaps", "SIG_Hcode", "SIG_Roadrunner" ,"max_suv_black", "max_suv_blue", "max_suv_green", "max_suv_red" , "shounka_f430_spider", "shounka_f430_spider_bleufonce", "shounka_f430_spider_grise", "shounka_f430_spider_jaune", "shounka_f430_spider_noir", "shounka_f430_spider_orange",  "shounka_f430_spider_rose", "shounka_f430_spider_rouge", "shounka_f430_spider_violet", "Mrshounka_lykan_c", "Mrshounka_lykan_c_bleufonce", "Mrshounka_lykan_c_grise", "Mrshounka_lykan_c_jaune", "Mrshounka_lykan_c_noir", "Mrshounka_lykan_c_orange", "Mrshounka_lykan_c_rose", "Mrshounka_lykan_c_rouge", "Mrshounka_lykan_c_violet", "Mrshounka_a3_308_civ", "Mrshounka_a3_308_civ_bleufonce",  "Mrshounka_a3_308_civ_grise", "Mrshounka_a3_308_civ_jaune", "Mrshounka_a3_308_civ_noir", "Mrshounka_a3_308_civ_orange",  "Mrshounka_a3_308_civ_rose", "Mrshounka_a3_308_civ_rouge", "Mrshounka_a3_308_civ_violet", "Mrshounka_corbillard_c", "Mrshounka_corbillard_c_bleufonce", "Mrshounka_corbillard_c_grise", "Mrshounka_corbillard_c_jaune", "Mrshounka_corbillard_c_orange", "Mrshounka_corbillard_c_rose", "Mrshounka_corbillard_c_rouge",  "Mrshounka_corbillard_c_violet", "shounka_avalanche", "shounka_avalanche_bleufonce",  "shounka_avalanche_grise", "shounka_avalanche_jaune", "shounka_avalanche_noir", "shounka_avalanche_orange", "shounka_avalanche_rose", "shounka_avalanche_rouge", "shounka_avalanche_violet"];
	IL_Supported_Hatchback = ["C_Hatchback_01_F", "C_Hatchback_01_sport_F" ,"max_BMW1" ,"max_BMW2", "max_BMW_M3_GTR3", "max_BMW_M3_GTR", "max_BMW_M3_GTR1", "max_BMW_M3_GTR2", "max_charger_black", "max_charger_blue", "max_charger_red", "max_lambo2", "max_lambo1", "max_lambo"];
	...
	IL_Supported_Quadbike = ["I_Quadbike_01_F", "C_Quadbike_01_F", "O_Quadbike_01_F", "B_G_Quadbike_01_F", "B_Quadbike_01_F", "CAF_Quadbike_OD", "CAF_Quadbike_AR", "Marinir_Quadbike_01_FG", "B_mas_mar_Quadbike_01_F", "max_bike", "max_bike1",  "max_bike2",  "max_bike3", "max_bike5"];
