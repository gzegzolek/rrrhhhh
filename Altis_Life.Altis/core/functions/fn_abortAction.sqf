...
1 fadeRadio 0;
1 fadeSpeech 0;
(uiNamespace getVariable ["playerHUD",displayNull]) closeDisplay 0;setViewDistance (viewDistance*1.5);
...
_outroCam camSetTarget vehicle player;_outroCam camSetRelPos [0,-1,1.85];
_outroCam camCommit 0;
waitUntil {camCommitted _outroCam};
_outroCam camSetFov 2;
_outroCam camSetRelPos [0,-5,1.85];_outroCam camCommit 0.7;
8 cutFadeOut 3;
waitUntil {camCommitted _outroCam};
